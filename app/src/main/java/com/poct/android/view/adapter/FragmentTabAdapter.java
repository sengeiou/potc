...
public class FragmentTabAdapter {
    ...
    private Activity fragmentActivity; // Fragment所属的Activity
    ...
    public FragmentTabAdapter(Activity fragmentActivity, List<Fragment> fragments, int fragmentContentId) {
