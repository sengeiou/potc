...
public class Utils {
    ...
    /**
     * Returns the manufacture name from the given mPadacharacteristic
     *
    ...
    /**
     * Returns the model number from the given mPadacharacteristic
     *
     * @param characteristic
    ...
    /**
     * Returns the serial number from the given mPadacharacteristic
     *
     * @param characteristic
    ...
    /**
     * Returns the hardware number from the given mPadacharacteristic
     *
     * @param characteristic
    ...
    /**
     * Returns the Firmware number from the given mPadacharacteristic
     *
     * @param characteristic
     * @return hardware_revision_name_string
     */
    ...
    /**
     * Returns the software revision number from the given mPadacharacteristic
     *
     * @param characteristic
     * @return hardware_revision_name_string
     */
    ...
    /**
     * Returns the PNP ID from the given mPadacharacteristic
     *
     * @param characteristic
     * @return {@link String}
     */
    ...
    /**
     * Returns the SystemID from the given mPadacharacteristic
     *
     * @param characteristic
     * @return {@link String}
     */
...
//        intentFilter.addAction(BluetoothLeService.ACTION_GATT_DESCRIPTORWRITE_RESULT);
    ...
    /**
     * Returns the Transmission power information from the mPadacharacteristic
     *
     * @param characteristics
     * @return {@link integer}
     */
