...
public class GattAttributes {
    ...
    //BLE100:
    public final static String USR_SERVICE2 = "0003cdd0-0000-1000-8000-00805f9b0131";

    public static final String USR_CHARACTERISTIC_NOTIFY2 = "0003cdd1-0000-1000-8000-00805f9b0131";

    public static String USR_CHARACTERISTIC_WRITE2 = "0003cdd2-0000-1000-8000-00805f9b0131";

    //BT200：

//    public final static String USR_SERVICE = "1b7e8251-2877-41c3-b46e-cf057c562023";
    public static final String USR_CHARACTERISTIC_NOTIFY = "8ac32d3f-5cb9-4d44-bec2-ee689169f626";
    public static String USR_CHARACTERISTIC_WRITE = "5e9bf2a8-f93f-4481-a67e-3b2f4a07891a";



    public final static String USR_SERVICE = "0003cdd0-0000-1000-8000-00805f9b0131";
    public final static String USR_NOTIFY = "0003cdd1-0000-1000-8000-00805f9b0131";
