...
public class CapSenseParser {
    /**
     * Parse the CapSense proximity value from the mPadacharacteristic
     *
    ...
    /**
     * Parse the CapSense slider value from the mPadacharacteristic
     *
     * @param characteristic
     * @return {@link integer}
     */
    ...
    /**
     * Parse the CapSense buttons value from the mPadacharacteristic
     *
     * @param characteristic
