...
public class CharacterParser {
	...
	public static String typeLetter = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
	...
	public String checkNumber(String chs)
	{
		String value;
		value = chs.replaceAll("0","ling");
		value = value.replaceAll("1","yi");
		value = value.replaceAll("2","er");
		value = value.replaceAll("3","san");
		value = value.replaceAll("4","si");
		value = value.replaceAll("5","wu");
		value = value.replaceAll("6","liu");
		value = value.replaceAll("7","qi");
		value = value.replaceAll("8","ba");
		value = value.replaceAll("9","jiu");
		return value;
	}

	/** * 词组解析 * * @param chs * @return */
	public String getSelling(String chsi) {
		String key, value,chs;
		chs = checkNumber(chsi);
